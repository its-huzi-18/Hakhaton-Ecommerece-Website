    ...
    <div className="w-full px-4 py-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <tr>
                ...
                <td className="py-4 px-4">
                  <input
                    ...
                    min="1"
                    defaultValue="1"
                    className="w-[32px] h-[32px] text-center pl-1 border border-gray-300 rounded-[4px] "
                  />
                </td>
                <td className="py-4 px-4">Rs. 250,000.00</td>
        ...
        <div className="bg-[#fff9e5] rounded-lg p-6">
          ...
          <button className=" my-6 h-[59px] w-[222px] border-[2px] border-black/50 hover:text-white rounded-lg hover:bg-gray-800 transition duration-300">
